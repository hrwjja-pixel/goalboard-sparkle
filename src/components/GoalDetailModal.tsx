...
import { Trash2, Plus, Maximize2, StickyNote, Pin, ChevronUp, ChevronDown, Pencil, Save, X, Paperclip, Upload, Download, FileText, Check } from 'lucide-react';
...
export const GoalDetailModal = ({ goal, open, onClose, onSave, onDelete, categories = ['SERVICE', 'AI', 'OPERATIONS'], categoryColors = {} }: GoalDetailModalProps) => {
